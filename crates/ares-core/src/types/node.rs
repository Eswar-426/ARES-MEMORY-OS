...
impl NodeType {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::ReviewTrigger => "review_trigger",
            Self::Person => "person",
            Self::Team => "team",
            Self::Commit => "commit",
...
impl std::str::FromStr for NodeType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "review_trigger" => Ok(Self::ReviewTrigger),
...
impl EdgeType {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::HasReviewTrigger => "has_review_trigger",
            Self::Drives => "drives",
...
impl std::str::FromStr for EdgeType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "has_alternative" => Ok(Self::HasAlternative),
            "has_review_trigger" => Ok(Self::HasReviewTrigger),

...
impl GapReasoner {
    ...
    pub fn reason(&self, mut gaps: Vec<Gap>) -> Result<Vec<Gap>, AresError> {
        let dec_store = DecisionStore::new((*self.store).clone());
        ...
        for gap in &mut gaps {
            match gap.gap_type {
                crate::models::GapType::MissingDecision => {
                    ...
                    let evidence = vec![
                        GapEvidence {
                            ...
                            explanation: "Requirement exists but has no decision links in the DB.".to_string(),
                        }
                    ];
                    ...
                    gap.reason = Some(GapReason {
                        ...
                        explanation: "Architectural traceability is broken between requirement and design.".to_string(),
                ...
                crate::models::GapType::MissingEvidence => {
                    ...
                    let evidence = vec![
                        GapEvidence {
                            ...
                            explanation: "Decision is approved or proposed but has 0 evidence records attached.".to_string(),
                        }
                    ];
                ...
                crate::models::GapType::MissingOwner => {
                    ...
                    let evidence = vec![
                        GapEvidence {
                            source_entity: dec_id.as_str().to_string(),
                            source_type: "Decision".to_string(),
                            explanation: "Decision is marked as Approved but the owner field is NULL.".to_string(),
                        }
                    ];
                    ...
                    gap.reason = Some(GapReason {
                        ...
                        explanation: "Decisions cannot be approved without a registered owner.".to_string(),
                        supporting_evidence: evidence,
                    });
                }
                crate::models::GapType::MissingImplementation => {
                    ...
                    let evidence = vec![
                        GapEvidence {
                            ...
                            source_type: "Requirement".to_string(),
                            explanation: "Requirement is marked Implemented but has 0 code traces.".to_string(),
                        }
                    ];
                ...
                crate::models::GapType::OrphanCode => {
                    ...
                    gap.reason = Some(GapReason {
                        root_cause: RootCause::TraceabilityBreakdown,
                        explanation: "Code components exist without any architectural justification.".to_string(),
                        supporting_evidence: evidence,
                    });
                }
            }

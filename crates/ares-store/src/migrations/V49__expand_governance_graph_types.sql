-- V49__expand_governance_graph_types.sql
-- Expand graph_nodes node_type constraint to include 'team'
-- Expand graph_edges edge_type constraint to include 'member_of', 'approved_by', 'reviewed_by'

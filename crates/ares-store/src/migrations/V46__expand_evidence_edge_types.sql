-- V46__expand_evidence_edge_types.sql
-- Expand graph_edges edge_type constraint to include 'supports', 'observes'
...
CREATE TABLE IF NOT EXISTS graph_edges_new (
  ...
  source        TEXT NOT NULL DEFAULT 'scanner'
                CHECK(source IN ('human','scanner','agent','inference','git_commits','git_blame','git_releases','git_branches','codeowners', 'evolution_engine', 'evidence_engine')),

...
impl CppExtractor {
    pub fn new() -> Self {
        ...
        let query_str = r#"
            ...
            (function_definition declarator: (function_declarator declarator: (identifier) @name)) @method
            ...
            (new_expression type: (type_identifier) @name) @construct
        "#;
...
mod tests {
    ...
    fn test_cpp_import_extraction() {
        ...
        let result = extractor
            .extract(&project_id, &file_node_id, "src/main.cpp", source_code)
            .unwrap();
